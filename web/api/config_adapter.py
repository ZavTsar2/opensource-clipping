...
def build_config_from_payload(
    ...
    *,
    ...
    cfg = SimpleNamespace(
        ...
        clip_category=payload.get("clip_category", "viral"),
        ...
        use_split_screen=payload.get("use_split_screen", False) or payload.get("crop_mode") == "reaction_split",
        use_dynamic_split=payload.get("use_dynamic_split", False),
        split_trigger="face" if payload.get("crop_mode") == "reaction_split" else payload.get("split_trigger", "diarization"),
