  ...
  async function startJob(event) {
    ...
    try {
      const job = await createJob({
        ...
        min_clip_seconds: duration, max_clip_seconds: duration + 10, clip_category: category,
